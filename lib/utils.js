...
var fs = require('fs');
var fsx = require('fs-extra');//additional windows support
...
module.exports.getCryptoSuite = function() {
    ...
    if (csEnv) // expecting a path to an alternative Crypto Suite implementation
        ...
        cryptoSuite = require('./CryptoSuite_ECDSA_SHA.js');
...
module.exports.newKeyValueStore = function(path) {
    ...
    if (kvsEnv) // expecting a path to an alternative KeyValueStore implementation
        ...
        store = require('./FileKeyValueStore.js');
...
module.exports.GenerateTarGz = function(src, dest, cb) {
    debug("GenerateTarGz");
...
// utility function to get relative file path for either Unix or Windows
module.exports.getRelativeFilePath = function(dir /*string*/) {        
...
// utility function to make directory for either 
// Unix or Windows(handles recursive).  
module.exports.mkdirSync = function(dir /*string*/) {
    dir = this.getRelativeFilePath(dir);    
    if(/^win/.test(process.platform)) {        
        fsx.mkdirsSync(dir);
    } else 
        fs.mkdirSync(dir);
...
module.exports.exists = function(absolutePath /*string*/) {
    try  {
